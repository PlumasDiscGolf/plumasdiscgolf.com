...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-3xl font-bold text-base-content">Add New Donation</h1>
    ...
    <form method="POST" action="?/createDonation" use:enhance={() => {
        isSaving = true;
        ...
        <div class="card-body space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="form-control">
                    ...
                    <input name="donorName" type="text" id="donorNameInput" placeholder="e.g., Jane Doe" class="input input-bordered w-full" bind:value={donorName} required />
                </div>
                <div class="form-control">
                    <label class="label" for="donorEmailInput"><span class="label-text">Donor Email</span></label>
                    <input name="donorEmail" type="email" id="donorEmailInput" placeholder="e.g., jane@example.com" class="input input-bordered w-full" bind:value={donorEmail} />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="form-control">
                    ...
                    <input name="amount" type="number" step="0.01" id="amountInput" placeholder="50.00" class="input input-bordered w-full" bind:value={amount} required />
                </div>
                <div class="form-control">
