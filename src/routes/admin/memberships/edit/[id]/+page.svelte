...
<div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-3xl font-bold text-base-content">Edit Membership</h1>
    ...
    <form method="POST" action="?/updateMembership" use:enhance={() => {
        isSaving = true;
        return async ({ update }) => {
        ...
        <div class="card-body space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="form-control">
                    ...
                    <input name="email" type="email" id="emailInput" class="input input-bordered w-full" bind:value={email} />
                </div>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                <div class="form-control">
                    <label class="label" for="memberSinceInput"><span class="label-text">Member Since*</span></label>
